...
# Tentative d'import de dj-database-url avec fallback
try:
...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,globalhealth-drepa.onrender.com').split(',')
